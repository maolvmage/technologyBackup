...
/**
 * <h1>具体调停者(ConcreteMediator)角色</h1> <p> 实现了抽象调停者所声明的事件方法。具体调停者知晓所有的具体同事类，并负责具体的协调各同事对象的交互关系。 <p>
 *
...
public class ConcreteMediator extends Mediator
{
    ...
    public void change(Colleague colleague)
    {
        if (colleague instanceof ConcreteColleagueA)
        {
            ...
            System.out.println("持有该调停者对象的类名为：" + colleague.getClass().getCanonicalName());
